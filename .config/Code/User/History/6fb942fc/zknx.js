...
//Add date, temp, humidity and wind to forecast cards
    ...
    dateCard1.innerHTML = `<div id="date2" class="column"><p class="title is-5">${cityDateJs2}</p>
    ...
    dateCard1.innerHTML = `<div id="date3" class="column"><p class="title is-5">${cityDateJs3}</p>
    ...
    dateCard1.innerHTML = `<div id="date4" class="column"><p class="title is-5">${cityDateJs4}</p>
