...
let search = document.createElement(`<p>Recent:${searchedEntry[i]}</p>`);
search.setAttribute("id", "recent-searches");
let prevSearchList = document.getElementById("recent-searches");
search.innerHTML(`<p> Recent:${searchedEntry[i]}</p>`);
searchedEntry.appendChild(search);
